"""Pinning tests for V6I21J hardpool balance calibration preset."""
...
class V6i21jHardpoolBalancePresetTests(unittest.TestCase):
    def test_aliases_resolve_to_hardpool_balance_arm(self) -> None:
        aliases = [
            "v6i21j",
            "v6i21j_hardpool_balance_calibration",
            "v6i21j_hardpool_balance",
            "latent_v6i21j_hardpool_balance_calibration",
    ...
    def test_v6i21j_is_exact_identity_diff_over_v6i21i(self) -> None:
        parent_cfg = apply_preset(PPOConfig(), "v6i21i")
        normalize_and_validate_training_config(parent_cfg)
        parent = dataclasses.asdict(parent_cfg)
        cfg_obj = apply_preset(PPOConfig(), "v6i21j")
        ...
        self.assertEqual(cfg_obj.experiment_id, "v6i21j")
        self.assertEqual(cfg_obj.run_tag, "v6i21j_hardpool_balance_calibration")

    def test_v6i21j_preserves_v6i21_scaffold_and_op_pool(self) -> None:
        cfg = apply_preset(PPOConfig(), "v6i21j")
