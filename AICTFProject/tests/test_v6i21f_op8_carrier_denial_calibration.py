"""Pinning tests for V6I21F OP8 carrier denial calibration preset."""
...
class V6i21fOp8CarrierDenialPresetTests(unittest.TestCase):
    def test_aliases_resolve_to_op8_denial_arm(self) -> None:
        aliases = [
            "v6i21f",
            "v6i21f_op8_carrier_denial_calibration",
            "v6i21f_op8_carrier_denial",
            "latent_v6i21f_op8_carrier_denial_calibration",
    ...
    def test_v6i21f_is_exact_identity_diff_over_v6i21e(self) -> None:
        parent_cfg = apply_preset(PPOConfig(), "v6i21e")
        normalize_and_validate_training_config(parent_cfg)
        parent = dataclasses.asdict(parent_cfg)
        cfg_obj = apply_preset(PPOConfig(), "v6i21f")
        ...
        self.assertEqual(cfg_obj.experiment_id, "v6i21f")
        self.assertEqual(cfg_obj.run_tag, "v6i21f_op8_carrier_denial_calibration")

    def test_v6i21f_preserves_v6i21_scaffold_and_op_pool(self) -> None:
        cfg = apply_preset(PPOConfig(), "v6i21f")
