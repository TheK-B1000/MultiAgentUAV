"""Reward V5 cleanup/confirmation probe -- objective-dominant budget, 300k steps, fresh seed.
...
Gate: artifacts/reward_v5/PROBE_GATE_FROZEN.json (frozen first).

Run:  python experiments/run_reward_v5_probe.py --seed 3100001
"""
...
V5_SEEDS = (3_100_001, 3_100_002, 3_100_003)
ABLATION_SEEDS = V5_SEEDS
...
def run_tag_for(seed: int) -> str:
    return f"g0_v2_rewardv5_seed{seed}"


def artifact_dir_for(seed: int) -> Path:
    return PROJECT_ROOT / "artifacts" / "reward_v5" / run_tag_for(seed)
...
def main() -> int:
    ...
    print("=" * 78)
    print(f"REWARD V5 CLEANUP/CONFIRMATION PROBE  seed={seed}  steps={TOTAL_TIMESTEPS:,}")
    ...
    report = {
        "probe": "Reward V5 cleanup/confirmation probe",
        "seed": seed,
