...
#       F4/F5 debug toggles | R reset | ESC quit
#   - Blue modes:
...
DEFAULT_PPO_MODEL_PATH = "checkpoints_sb3/research_model_phase1.zip"
...
class SB3TeamPPOPolicy:
    ...
    def _build_team_obs(self, game_field: ViewerGameField, side: str) -> Dict[str, np.ndarray]:
        ...
        mask = np.concatenate(mask_list, axis=0).astype(np.float32)  # [10]
