...
BT_PROFILES: Dict[int, BTProfile] = {
    ...
    8: _profile(
        ...
        enable_2v1=True,
        lock_intercept=14,
        intercept_block_base=0.66,
        intercept_block_trailing_bonus=0.28,
        intercept_feasibility_ratio=0.76,
        lane_amplitude_frac=0.38,
    ...
    9: _profile(
        ...
        defender_zone_frac=0.06,
        late_game_evasion_unlock=True,
        threat_radius=9.5,
        intercept_block_base=0.70,
        intercept_block_trailing_bonus=0.26,
        enable_mines=True,
        mine_defender_lane_frac=0.50,
        mine_cooldown_steps=36,
        mine_approach_lead_steps=20,
        adaptive_enabled=True,
    ),
    10: _profile(
        10,
