...
class BTProfile:
    ...
    # OP8..OP12 adaptive hardpool v2 (v6i21+): intra-episode anti-repeat memory.
...
BT_PROFILES: Dict[int, BTProfile] = {
    ...
    8: _profile(
        ...
        enable_2v1=True,
        lock_intercept=12,
        intercept_block_base=0.58,
        intercept_block_trailing_bonus=0.24,
        intercept_feasibility_ratio=0.82,
        lane_amplitude_frac=0.34,
        adaptive_enabled=True,
    ),
    9: _profile(
        9,
        "OP9_ADAPTIVE_FORTRESS",
        enable_escort=False,
        enable_intercept=True,
        enable_counter=False,
        counter_always=False,
    ...
    11: _profile(
        ...
        escort_interpose=True,
        lock_intercept=8,
        intercept_block_base=0.54,
        lane_amplitude_frac=0.32,
        adaptive_enabled=True,
    ),
    12: _profile(
        12,
        "OP12_ADAPTIVE_COUNTER",
        enable_escort=True,
        enable_intercept=True,
        enable_counter=True,
        counter_always=True,
