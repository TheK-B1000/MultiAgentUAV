...
DEFAULT_METRIC_SCHEMA: dict[str, AggregationMode] = {
    ...
    "exp2b_gradient_cosine_last": AggregationMode.LAST,
    "exp2b_gradient_cosine_mean": AggregationMode.LAST,
    "exp2b_gradient_cosine_p10": AggregationMode.LAST,
    "exp2b_gradient_cosine_p50": AggregationMode.LAST,
    "exp2b_gradient_cosine_p90": AggregationMode.LAST,
    "exp2b_gradient_cosine_count": AggregationMode.LAST,
    "exp2c_private_heads_active": AggregationMode.LAST,
    "exp2c_private_head_count": AggregationMode.LAST,
    "exp2c_head0_max_abs_delta": AggregationMode.LAST,
    "exp2c_head1_max_abs_delta": AggregationMode.LAST,
    "exp2c_head0_teacher_grad_norm": AggregationMode.LAST,
    "exp2c_head1_teacher_grad_norm": AggregationMode.LAST,
